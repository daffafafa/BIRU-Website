			...
			<div class="container">
				...
				<div class="crumbs">
					<ul id="breadcrumbs" class="breadcrumb">
                        ...
                        <li class="current">
							<a href="#" title="">Daftar Peserta Terdampak Gempa</a>
						</li>
					</ul>
				...
				<script>
					$(document).ready(function(){
						...
						$('#cari').on('click',function(){
							...
							$('#excel').attr('href','./cetak.php?p=peserta&a=terdampak&id=<?=$_GET['id']?>&awal='+$('#awal').val()+'&akhir='+$('#akhir').val());
							App.blockUI($("#content"));
							//setTimeout(function ()
							//{
							var ajaxRequest;
							...
							formData.set("type","peserta_terdampak");
						...
						<div class="widget box">
							<div class="widget-content" >
								<div style="text-align:center;cursor:default;margin: auto;width: fit-content;">
									<h3 class='agileinfo_sign'>Laporan Peserta Terdampak Bencana</h3><br>
					...
					<div class="col-md-12" >
						<div class="widget box"  id ="ganti">
							<div class="widget-header">
								<h3>Daftar Peserta Terdampak Gempa Produk <?=$produk[0]['PROD_NAMA']?></h3>
							...
							<div class="widget-content no-padding">
								<table id="tabel1" data-money="5 6 7" data-persen="15 16" class="table table-striped table-bordered table-hover table-responsive">
									<thead>
										<tr>
											<th>Waktu Bencana</th>
											<th>Gempa (SR)</th>
											...
											<th data-hide="always">KTP</th>
											<th data-hide="always">Lintang Cabang</th>
											<th data-hide="always">Bujur Cabang</th>
											<th data-hide="always">Resiko Santunan (%)</th>
											<th data-hide="always">Share Risk(%)</th>
										</tr>
									</thead>
									<tbody>
