	...
	<div id="container">
                        ...
                        <div class="panel">
                            ...
                            <div class="panel-body">
                                <div class="validate-input col-12 row-flex" data-validate="Silakan Masukkan KTP/Loan ID">
                                    ...
                                    <input type="text" id="ktp" name="ktp" placeholder="No KTP/LOAN ID Peserta" class="form-control col-lg-5 col-md-6 col-sm-7 col-xs-12" required>
                                </div>
                                <div class="mt-sm-4 validate-input col-12 row-flex" data-validate="Silakan Masukkan Nama">
                                    ...
                                    <input type="text" id="nama" name="nama" placeholder="Nama Peserta" class="form-control col-lg-5 col-md-6 col-sm-7 col-xs-12" required>
                                </div>
        ...
        <?php }?>
                                ...
                                <div class="validate-input col-12 row-flex" data-validate="Silakan Masukkan Tanggal Lahir">
                                    ...
                                    <input type="date" id="lahir" name="lahir" class="form-control col-xl-2 col-lg-3 col-md-4 col-sm-4 col-xs-12" required value="">
                                </div>
                                <div class="mt-sm-4 validate-input col-12 row-flex" data-validate = "Silakan Masukkan Alamat Anda">
                                    ...
                                    <textarea class="form-control col-lg-8 col-md-7 col-xs-12" name="alamat" id="alamat" placeholder="Alamat Peserta"></textarea>
                                </div>
                            </div>
                        </div>
                        <div class="panel">
        ...
        <?php }?>
                                ...
                                <div class="validate-input col-12 row-flex m-0" data-validate = "Plafond Pembayaran">
                                    ...
                                    <input name="plafond" id="plafond" type="text" required class="form-control col-lg-3 col-sm-5 col-xs-8" style="text-align:right" placeholder="0.00">
                                </div>
                                <div class="mt-sm-4 validate-input col-12 row-flex m-0" data-validate="Silahkan Masukkan Pencairan ID">
                                    ...
                                    <input class="form-control col-lg-4 col-sm-6 col-xs-12" id="pencairan" required type="text" name="pencairan" placeholder="Pencairan ID">
                                </div>
                                <div class="mt-sm-4 validate-input col-12 row-flex m-0" data-validate="Silahkan Masukkan Tanggal Pencariran">
                                    ...
                                    <input value="<?=date('Y-m-d')?>" class="form-control col-xl-2 col-lg-3 col-md-4 col-sm-4 col-xs-12" id="tanggal_pencairan" required type="date" name="tanggal_pencairan">
                                </div>
                                <div class="mt-sm-4 validate-input col-12 row-flex m-0" data-validate="Silahkan Masukkan Jumlah Minggu">
                                    ...
                                    <input type="number" min="1" required class="form-control col-xl-2 col-lg-3 col-md-4 col-sm-4 col-xs-12" name="minggu" id="minggu" placeholder="Jumlah Minggu">
                                </div>
                                <div class="mt-sm-4 validate-input col-12 row-flex m-0" style="margin-left:unset" data-validate="Silahkan Masukkan Tanggal Awal">
                                    ...
                                    <input class="form-control col-xl-2 col-lg-3 col-md-4 col-sm-4 col-xs-12" value="<?=date('Y-m-d')?>" id="awal_periode" required type="date" name="awal_periode">
                                </div>
                                <div class="mt-sm-4 validate-input col-12 row-flex m-0" data-validate="Silahkan Masukkan Tanggal Akhir">
                                    ...
                                    <input class="form-control col-xl-2 col-lg-3 col-md-4 col-sm-4 col-xs-12" value="<?=date('Y-m-d')?>" min="<?=date('Y-m-d')?>" id="akhir_periode" required type="date" name="akhir_periode">
                                </div>
                                <div class="mt-sm-4 validate-input col-12 row-flex m-0" data-validate="Silahkan Masukkan Nilai UK">
                                    ...
                                    <input type="text" min="0" style="text-align:right" required class="form-control col-lg-4 col-sm-6 col-xs-12" name="uk" id="uk" placeholder="0.00">
                                </div>
                                <div class="col-12 mt-sm-4 row-flex m-0" >
                                    <label class="col-lg-3 col-md-5 col-sm-5 col-xs-12 p-0">Premi</label>
                                    <input type="text" style="text-align:right" readonly class="form-control col-lg-4 col-sm-6 col-xs-12 " name="premi_pinjam" id="premi_pinjam" placeholder="0.00">
                                </div>
                            </div>
                        </div>  
