			...
			<div class="container">
				...
				<div class="crumbs">
					<ul id="breadcrumbs" class="breadcrumb">
						...
						<li class="current">
							<a href="#" title="">Laporan Peserta Aktif</a>
						</li>
					</ul>
				...
				<script>
					$(document).ready(function(){
						...
						$('#cari').on('click',function(){
							...
							$('#excel').attr('href','./cetak.php?p=peserta&a=aktif&id=<?=$_GET['id']?>&awal='+$('#awal').val()+'&akhir='+$('#akhir').val());
							App.blockUI($("#content"));
							//setTimeout(function ()
							//{
							var ajaxRequest;
						...
						<div class="widget box">
							<div class="widget-content" >
								<div style="text-align:center;cursor:default;margin: auto;width: fit-content;">
									<h3 class='agileinfo_sign'>Laporan Peserta Aktif</h3><br>
					...
					<div class="col-md-12">
						<div class="widget box" id ="ganti">
							<div class="widget-header">
								<h3>Daftar Peserta Aktif Produk <?=$produk[0]['PROD_NAMA']?></h3>
