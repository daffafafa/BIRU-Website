<body>
                        ...
                        <div class="panel">
                            <div class="panel-body">
                                ...
                                <div class="validate-input col-12 row-flex" data-validate="Silakan Masukkan Kode Cabang/Lokasi">
                                    ...
                                    <input type="text" id="kode" name="kode" class="form-control col-lg-5 col-md-6 col-sm-7 col-xs-12" required value="<?=($data['LOKASI_ID'])?>">
                                </div>
                                <div class="validate-input col-12 row-flex mt-4 " data-validate="Silakan Masukkan Nama Cabang/Lokasi">
                                    ...
                                    <input type="text" id="nama" name="nama" class="form-control col-lg-5 col-md-6 col-sm-7 col-xs-12" required value="<?=($data['LOKASI_NAMA'])?>">
                                </div>
                                <div class="validate-input col-12 row-flex input100-select pt-4 " data-validate="Silakan Pilih Status">
                                    ...
                                    <div class="col-lg-2 col-md-3 col-sm-5 col-xs-12 p-0">
                                        <select class="js-select2" required name="status" id="status">
                                            <option value="0" <?=($data['LOKASI_STATUS'] == 0) ? 'selected' : null?> >ACTIVE</option>
                                            <option value="1" <?=($data['LOKASI_STATUS'] == 1) ? 'selected' : null?> >SUSPENDED</option>
                                            <option value="2" <?=($data['LOKASI_STATUS'] == 2) ? 'selected' : null?> >CLOSED</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="validate-input col-12 row-flex" data-validate="Silakan Pilih Provinsi">
                                    ...
                                    <div class="col-lg-4 col-md-6 col-sm-7 col-xs-12 p-0">
                                        <select required  id="provinsi" name="provinsi" class="js-select2">
                                            <?php 
                                                //required $index_akhir_wilayah, ordered data from prov,kab,kec,kel
                                                $index_akhir_wilayah = 0;
                                                for($i=$index_akhir_wilayah;$i < count($arrWilayah);$i++){
                                                    if($arrWilayah[$i]['level'] != 1) {
                                                        $index_akhir_wilayah = $i;
                                                        break;
                                                    }
                                            ?>
                                                <option <?=($arrWilayah[$i]['kode_wilayah_bps']==$data['LOKASI_PROVINSI'])?'selected':''?> value="<?=$arrWilayah[$i]['kode_wilayah_bps']?>" <?=(! ($arrWilayah[$i]['lat']=="" || $arrWilayah[$i]['lng']==""))?'koor="'. $arrWilayah[$i]['lat'] . ',' .  $arrWilayah[$i]['lng'] .'"':''?> zona="<?=$arrWilayah[$i]['zonasi']?>" pos="<?=$arrWilayah[$i]['pos']?>"><?=$arrWilayah[$i]['nama']?></option>
                                            <?php } ?>
                                        </select>
                                        <div class="dropDownSelect2"></div>
                                    </div>
                                </div>
                                <div class="validate-input col-12 row-flex" data-validate="Silakan Pilih Kabupaten/Kota">
                                    ...
                                    <div class="col-lg-4 col-md-6 col-sm-7 col-xs-12 p-0">
                                        <select required  id="kabupaten" name="kabupaten" class="js-select2">
                                            <?php 
                                                //required $index_akhir_wilayah, ordered data from prov,kab,kec,kel
                                                for($i=$index_akhir_wilayah;$i < count($arrWilayah);$i++){
                                                    if($arrWilayah[$i]['level'] != 2) {
                                                        $index_akhir_wilayah = $i;
                                                        break;
                                                    }
                                            ?>
                                                <option <?=($arrWilayah[$i]['kode_wilayah_bps']==$data['LOKASI_KABUPATEN'])?'selected':''?> value="<?=$arrWilayah[$i]['kode_wilayah_bps']?>" <?=(! ($arrWilayah[$i]['lat']=="" || $arrWilayah[$i]['lng']==""))?'koor="'. $arrWilayah[$i]['lat'] . ',' .  $arrWilayah[$i]['lng'] .'"':''?> zona="<?=$arrWilayah[$i]['zonasi']?>" pos="<?=$arrWilayah[$i]['pos']?>"><?=$arrWilayah[$i]['nama']?></option>
                                            <?php } ?>
                                        </select>
                                        <div class="dropDownSelect2"></div>
                                    </div>
                                </div>
                                <div class="validate-input col-12 row-flex" data-validate="Silakan Pilih Kecamatan">
                                    ...
                                    <div class="col-lg-4 col-md-6 col-sm-7 col-xs-12 p-0">
                                        <select required  id="kecamatan" name="kecamatan" class="js-select2">
                                            <?php 
                                                //required $index_akhir_wilayah, ordered data from prov,kab,kec,kel
                                                for($i=$index_akhir_wilayah;$i < count($arrWilayah);$i++){
                                                    if($arrWilayah[$i]['level'] != 3) {
                                                        $index_akhir_wilayah = $i;
                                                        break;
                                                    }
                                            ?>
                                                <option <?=($arrWilayah[$i]['kode_wilayah_bps']==$data['LOKASI_KECAMATAN'])?'selected':''?> value="<?=$arrWilayah[$i]['kode_wilayah_bps']?>" <?=(! ($arrWilayah[$i]['lat']=="" || $arrWilayah[$i]['lng']==""))?'koor="'. $arrWilayah[$i]['lat'] . ',' .  $arrWilayah[$i]['lng'] .'"':''?> zona="<?=$arrWilayah[$i]['zonasi']?>" pos="<?=$arrWilayah[$i]['pos']?>"><?=$arrWilayah[$i]['nama']?></option>
                                            <?php } ?>
                                        </select>
                                        <div class="dropDownSelect2"></div>
                                    </div>
                                </div>
                                <div class="validate-input col-12 row-flex" data-validate="Silakan Pilih Kelurahan/Desa">
                                    ...
                                    <div class="col-lg-4 col-md-6 col-sm-7 col-xs-12 p-0">
                                        <select required  id="kelurahan" name="kelurahan" class="js-select2">
                                            <?php 
                                                ...
                                                //required $index_akhir_wilayah, ordered data from prov,kab,kec,kel
                                                for($i=$index_akhir_wilayah;$i < count($arrWilayah);$i++){
                                                    if($arrWilayah[$i]['level'] != 4) {
                                                        $index_akhir_wilayah = $i;
                                                        break;
                                                    }
                                                    if($arrWilayah[$i]['kode_wilayah_bps']==$data['LOKASI_KELURAHAN'])
                                                    {
                                                        $zona=$arrWilayah[$i]['zonasi'];
                                                    }
                                                ?> 
                                                <option <?=($arrWilayah[$i]['kode_wilayah_bps']==$data['LOKASI_KELURAHAN'])?'selected':''?> value="<?=$arrWilayah[$i]['kode_wilayah_bps']?>" <?=(! ($arrWilayah[$i]['lat']=="" || $arrWilayah[$i]['lng']==""))?'koor="'. $arrWilayah[$i]['lat'] . ',' .  $arrWilayah[$i]['lng'] .'"':''?> zona="<?=$arrWilayah[$i]['zonasi']?>" pos="<?=$arrWilayah[$i]['pos']?>"><?=$arrWilayah[$i]['nama']?></option>
                                            <?php } ?>
                                        </select>
                                        <div class="dropDownSelect2"></div>
                                    </div>
                                </div>
                                <div class="col-12 row-flex input100-select" data-validate="Silahkan Pilih Bank Rekening">
                                    ...
                                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12 p-0 my-1">
                                        <select reqs  id="bank_rekening" name="bank_rekening" class="js-select2">
                                            <option value="BNI" <?=$data['BANK_REKENING']=='BNI'?'selected':null ?>>BNI</option>
                                        </select>
                                        <div class="dropDownSelect2"></div>
                                    </div>
                                </div>
                                <div class="validate-input col-12 row-flex mt-4 " data-validate="Silakan Masukkan No Rekening">
                                    ...
                                    <input type="text" id="no_rekening" name="no_rekening" class="form-control col-lg-5 col-md-6 col-sm-7 col-xs-12" required value="<?=($data['NO_REKENING'])?>">
                                </div>
                                <div class="validate-input col-12 row-flex mt-4 " data-validate="Silakan Masukkan Nama Rekening">
                                    ...
                                    <input type="text" id="nama_rekening" name="nama_rekening" class="form-control col-lg-5 col-md-6 col-sm-7 col-xs-12" required value="<?=($data['NAMA_REKENING'])?>">
                                </div>

                                <div class="col-12 row-flex mt-4 mt-sm-0">
                                    <label class="col-lg-3 col-md-4 col-sm-5 col-xs-6 p-0">Zona Lokasi</label>
                                    <input type="text" id="zona" name="zona" class="col-lg-1 col-md-2 col-sm-3 col-xs-6 p-0" readonly required value="<?=$zona?>">
                                </div>
                                <div class="badge badge-info" id='koorChange'></div>
                                <div class="validate-input col-12 row-flex mt-0 mt-sm-3" data-validate="Silakan Pilih Koordinat">
                                    ...
                                    <input type="text" id="koord" name="koord" class="col-lg-5 col-md-6 col-sm-7 col-xs-12 p-0" readonly required value="<?=($data['lat']) . ',' . ($data['lng'])?>">
                                    <a href="#petaform" data-toggle="modal" class="btn btn-lg btn-primary ml-0 ml-lg-4">Sesuaikan Koordinat</a>
                                </div>
                                
                                <div class="pull-left">
                                    <a href="./?p=cabang&id=<?=$_GET['id']?>" class="btn-lg btn btn-warning ">Kembali</a>
                                    <button value="SEND" type="submit" class="btn btn-lg btn-primary">Simpan</button>
                                </div>
                            </div>
                        </div>
                    </form>
    ...
    <script>
		$(document).ready(function(){
            // ambilData2('#provinsi','<?=$data['LOKASI_PROVINSI']?>',1);
            // ambilData2('#kabupaten','<?=$data['LOKASI_KABUPATEN']?>',2);
            // ambilData2('#kecamatan','<?=$data['LOKASI_KECAMATAN']?>',3);
            // ambilData2('#kelurahan','<?=$data['LOKASI_KELURAHAN']?>',4);
            ...
            $('#kelurahan').on('change',function(){
                ...
                if(typeof koor !== "undefined"){
                    $('#koord').val(koor.value);
                }else{
                    $('#koorChange').text('Koordinat telah berganti karena perubahan kelurahan/desa atau pemilihan koordinat baru, silahkan sesuaikan kordinat baru');
                    $('#koord').val('');
                ...
                ajaxRequest.onreadystatechange = function(){
                    if(ajaxRequest.readyState == 4){
                        ...
                        if(JSONObject != false)
                        {
                            ...
                            JSONObject.forEach(function(data){
                                if(a=='kelurahan'){
                                    $(obj).append('<option '+(data.id==id?'selected':null)+' value="'+data.id+'" ' +
                                    ' koor="'+data.koor+'" ' +
                                    ' zona="'+data.zona+'" pos="'+data.pos+'">'+data.nama+'</option>');
                                }else{
                                    $(obj).append('<option '+(data.id==id?'selected':null)+' value="'+data.id+'" ' +
                                        '" pos="'+data.pos+'">'+data.nama+'</option>');
                                }
                            });
                        }else{
                            $(obj).append('<option selected disabled>Tidak ada '+a+'</option>');
