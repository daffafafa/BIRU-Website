			...
			<div class="container">
				...
				<script>
					$(document).ready(function(){
                        ...
                        var idPenanggungTerpilih = [];
                        var idPenanggungTerpilih2 = [];
                        ...
                        <div class="panel">
                            <div class="panel-body">
                                ...
                                <div class="col-12 row-flex" >
                                    <label class="col-lg-4 col-md-5 col-sm-5 col-xs-12 p-0">Kode Sub Produk</label>
                                ...
                                <div class="col-12 row-flex" data-validate="Silakan Pilih Partner">
                                    <label class="col-lg-4 col-md-5 col-sm-5 col-xs-12 p-0">Partner</label>
                                    <div class="col-lg-5 col-md-6 col-sm-7 col-xs-12 p-0">
                                        <select required name="partner" class="js-select2" id="partner" data-placeholder="<?=((count($partner) > 0)?'Pilih Partner':'Tidak ada partner yg bisa ditambah')?>">
                                            <?php foreach($partner as $row) {?>
                                                <option value="<?=$row['ENTITY_ID']?>"><?=$row['ENTITY_NAMA']?></option>
                                            <?php }?>
                                        </select>
                                ...
                                <div class="col-12 row-flex">
                                    ...
                                    <div class="col-lg-5 col-md-6 col-sm-7 col-xs-12 p-0">
                                        <select required name="level" class="js-select2" id="level">
                                            ...
                                            <option value="1">Re Asuransi</option>
                                        </select>
                                        <div class="dropDownSelect2"></div>
                                    </div>
                                </div>
                                ...
                                <div class="col-12 row-flex validate-input" data-validate="Silakan Masukkan No Rekening">
                                    ...
                                    <input type="text" id="dana_in_no" name="dana_in_no" class="form-control col-lg-5 col-md-6 col-sm-7 col-xs-12" required>
                                </div>
                                <div class="col-12 row-flex validate-input" data-validate="Silakan Masukkan Nama Rekening">
                                    ...
                                    <input type="text" id="dana_in_nama" name="dana_in_nama" class="form-control col-lg-5 col-md-6 col-sm-7 col-xs-12" required>
                                </div>
                                <div class="col-12 row-flex validate-input" data-validate="Silakan Masukkan Porsi Resiko">
                                    ...
                                    <input type="text" min="0" max="<?=(100 - $totalResiko)?>" step=".01" id="porsi" name="porsi" class="form-control col-lg-5 col-md-6 col-sm-7 col-xs-12" required>
                                </div>
                                <div class="col-12 row-flex validate-input">
    ...
    var a;
		$(document).ready(function(){            
            $('#form').on('submit',function(e){
                ...
                if($('#partner')[0].selectedIndex==-1){
                    check=false;
                    err="Silahkan Pilih Partner";
                }
            ...
            function simpan(){
                ...
                formData.set("type","business_rules_detail_tambah");
