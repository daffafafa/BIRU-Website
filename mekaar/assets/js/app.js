...
var App = (function ()
{
  ...
  var handleSidebarMenu = function ()
  {
    ...
    $("li:has(ul)", "#sidebar-content ul").each(function ()
    {
      ...
      {
        $(">a", this).append(
          "<i class='arrow " + arrow_class_closed + "'></i>"
        );
      }
    });
    ...
    $("#sidebar-content ul > li > a").on("click", function (e)
    {
      ...
      if ($(window).width() > 767)
      {
        ...
        parent
          ...
          .children("a")
          .children("i.arrow")
          .removeClass(arrow_class_open)
          .addClass(arrow_class_closed);
        parent
          .children("li.open")
          .children(".sub-menu")
          .slideUp(200);
        parent
          .children("li.open-default")
          .children(".sub-menu")
          .slideUp(200);
        parent
          .children("li.open")
      ...
      {
        $("i.arrow", $(this))
          .removeClass(arrow_class_closed)
          .addClass(arrow_class_open);
        $(this)
          .parent()
          .addClass("open");
  ...
  {
    var android_chrome = /android.*chrom(e|ium)/.test(
  ...
  var handleCheckableTables = function ()
  {
    $(".table-checkable thead th.checkbox-column :checkbox").on(
      ...
      function ()
      {
        ...
        var data_horizontalWidth = $(this)
          .parents("table.table-checkable")
          .data("horizontalWidth");
        if (typeof data_horizontalWidth != "undefined")
        {
          var $checkable_table_body = $(this)
  ...
  var handleProjectSwitcher = function ()
  {
    ...
    $("body").click(function (e)
    {
      ...
      if (
        $.inArray("project-switcher", classes) == -1 &&
        $.inArray("project-switcher-btn", classes) == -1 &&
        $(e.target)
          .parents()
          .index($(".project-switcher")) == -1 &&
        $(e.target).parents(".project-switcher-btn").length == 0
      )
      {
  ...
  return {
    ...
    blockUI: function (el, centerY)
    {
      var el = $(el);
      el.block({
        message: '<img src="../../../../assets/img/loading.gif" alt="">',
